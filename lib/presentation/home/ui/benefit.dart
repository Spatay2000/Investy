...
import 'package:investy/presentation/home/provider/benefit_provider.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Benefit', style: TextStyle(color: AppColors.textColor)),
          centerTitle: false,
        ),
        body: BaseProvider<BenefitProvider>(
